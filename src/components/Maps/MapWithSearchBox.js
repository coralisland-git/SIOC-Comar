                            ...
                            <div>
                                <img
                                    src={props.dwellings[index].images[0] !== undefined
                                        ? props.dwellings[index].images[0].thumbnail_url.replace('/upload/', '/upload/w_400,q_auto,f_auto/')
                                        : 'https://res.cloudinary.com/sioc/image/upload/w_400,q_auto,f_auto/v1525712940/epnvioppkpvwye1qs66z.jpg'}
                                    alt=""
